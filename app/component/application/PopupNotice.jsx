    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-900 text-white w-[90%] max-w-md rounded-2xl p-5 shadow-lg border border-gray-700">
        ...
        <div className="space-y-3 text-sm leading-relaxed">
          <p>
            🔴 <b>BR</b> এর বাহিরের প্লেয়ার নিয়ে ঝুকবেননা এবং ইনভাইট দিবেন না —
            নাহলে সোজা কিক খাবেন টাকা বেক পাবেন না 🚫
          </p>

          <p>
            💬 ডিপোজিটে সমস্যা হলে <b>টেলিগ্রামে মেসেজ দিন ✅</b> নাহলে কল দিবেন
            না দয়া করে 🚫
          </p>

          <p>
            💥 <b>উইথড্র</b> নগদে পাঠালে তারাতারি পাবেন 🔥 বিকাশে দিলে লেট হতে
            পারে 😅
          </p>
