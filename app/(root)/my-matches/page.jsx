export default function MyMatches() {
  ...
  return (
    <div className="min-h-screen my-18 bg-[#0a0a1a] text-white p-4">
      ...
      <div className="space-y-3">
        {matches.map((match, index) => (
          <div
            key={index}
            className="bg-gray-900 rounded-2xl border-2 shadow-md p-4 flex justify-between items-center hover:bg-gray-800 transition-all"
          >
            ...
            <div className="flex  items-center justify-around text-center gap-6 w-fit ">
              ...
              <div className="bg-gray-800  flex flex-col items-center justify-center ">
                <strong className="text-gray-200 font-semibold">Win:</strong>
                <span>{match.kills}</span>
              </div>
            </div>
          </div>
